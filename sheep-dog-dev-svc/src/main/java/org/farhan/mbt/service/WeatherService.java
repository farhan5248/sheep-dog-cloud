...
public class WeatherService {
	 ...
	 */
	@Tool(name = "Get weather forecast by co-ordinates", description = "Get weather forecast for a specific latitude/longitude")
	 ...
	 * @throws RestClientException if the request fails
	 */
	@Tool(name = "Get alerts for a state", description = "Get weather alerts for a US state. Input is Two-letter US state code (e.g. CA, NY)")
