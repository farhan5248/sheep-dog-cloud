 ...
 * </p>
 * <ul>
 *   <li>{@link org.farhan.dsl.asciidoc.asciiDoc.impl.NestedDescriptionImpl#getLineList <em>Line List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NestedDescriptionImpl extends MinimalEObjectImpl.Container implements NestedDescription
{
  ...
  {
    return AsciiDocPackage.Literals.NESTED_DESCRIPTION;
  }
  ...
  public EList<Line> getLineList()
  {
    if (lineList == null)
    {
      lineList = new EObjectContainmentEList<Line>(Line.class, this, AsciiDocPackage.NESTED_DESCRIPTION__LINE_LIST);
    }
    return lineList;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AsciiDocPackage.NESTED_DESCRIPTION__LINE_LIST:
