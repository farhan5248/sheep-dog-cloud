...
public class InternalAsciiDocLexer extends Lexer {
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAsciiDoc.g:1497:11: (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' | '|' | '#' ) ) (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' ) ) )* )
            // InternalAsciiDoc.g:1497:13: ~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' | '|' | '#' ) ) (~ ( ( ' ' | '\\t' | '\\r' | '\\n' | '[' | ']' ) ) )*
            {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAsciiDoc.g:1499:9: ( ( ' ' | '\\t' | '\\r' )+ )
            // InternalAsciiDoc.g:1499:11: ( ' ' | '\\t' | '\\r' )+
            {
            // InternalAsciiDoc.g:1499:11: ( ' ' | '\\t' | '\\r' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAsciiDoc.g:1501:17: ( '#' (~ ( '\\n' ) )* RULE_EOL )
            // InternalAsciiDoc.g:1501:19: '#' (~ ( '\\n' ) )* RULE_EOL
            {
            match('#'); 
            // InternalAsciiDoc.g:1501:23: (~ ( '\\n' ) )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_EOL() throws RecognitionException {
        try {
            int _type = RULE_EOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAsciiDoc.g:1503:10: ( ( '\\n' )+ )
            // InternalAsciiDoc.g:1503:12: ( '\\n' )+
            {
            // InternalAsciiDoc.g:1503:12: ( '\\n' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_RAWTEXT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAsciiDoc.g:1505:14: ( '----' '\\n' ( . )+ '\\n' '----' )
            // InternalAsciiDoc.g:1505:16: '----' '\\n' ( . )+ '\\n' '----'
            {
            match("----"); 

            match('\n'); 
            // InternalAsciiDoc.g:1505:28: ( . )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
